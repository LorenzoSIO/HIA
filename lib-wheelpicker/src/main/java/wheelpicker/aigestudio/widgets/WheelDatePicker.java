package wheelpicker.aigestudio.widgets;
...
import wheelpicker.aigestudio.IDebug;
import wheelpicker.aigestudio.IWheelPicker;
import wheelpicker.aigestudio.R;
import wheelpicker.aigestudio.WheelPicker;
...
public class WheelDatePicker extends LinearLayout implements WheelPicker.OnItemSelectedListener,
    ...
    public WheelDatePicker(Context context, AttributeSet attrs) {
        ...
        setSelectedItemTextColor(ContextCompat.getColor(context, R.color.colorBlack));
        ...
        /** init wheel date picker with the date of today */
        setYearStart(calendar.get(Calendar.YEAR));
        setSelectedDay(calendar.get(Calendar.DATE));
        setSelectedMonth(calendar.get(Calendar.MONTH) + 1);
